#ifndef __OC_TRADER_COMMANDER_HUAXIN_H__
#define __OC_TRADER_COMMANDER_HUAXIN_H__
#include <string>
#include <list>
#include <mutex>
...
public:
	OcTraderCommanderHuaxin(uv_loop_s* loop, std::string configPath);
	virtual ~OcTraderCommanderHuaxin();
